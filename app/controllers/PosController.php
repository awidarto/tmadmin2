...
class PosController extends AdminController {
    ...
    public function tableResponder()
    {
        ...
        */
        ...
        $aadata[] = array('','','','','<b style="text-align:right;font-size:18px;">Total</b>','<b style="text-align:right;font-size:18px;">IDR</b>','<b style="font-size:18px;">'.Ks::idr($grand_total).'</b><input type="hidden" id="total_price_value" value="'.$grand_total.'">');
