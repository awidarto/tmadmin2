...
class Barcode{
    ...
    public function make( $text, $code_type = 'code128' ,$size = '20', $orientation = 'horizontal', $showtxt = false ){
    ...
    public function render($type, $filename = 'imgfile' , $save = false){
        ...
        'Content-Description'       => 'File Transfer',
                ...
                'Content-Disposition'       => 'attachment; filename="'. $name = $website->validation->code . '.html"',
                'Content-Transfer-Encoding' => 'binary',
                'Expires'                   => 0,
                'Cache-Control'             => 'must-revalidate, post-check=0, pre-check=0',
                'Pragma'                    => 'public',
                'Content-Length'            => mb_strlen($name)
        */
    	...
    	if($save){
            if($type == 'gif'){
                ...
                header('Content-Disposition: attachment; filename="'.$filename.'.jpg"');
                imagejpeg($this->barcode, null, 100);
                imagedestroy($this->barcode);
            }
